...
//ПОЛЬЗОВАТЕЛИ//
    ...
    // Метод по поиску и сортировке пользователей, отображение шаблона
...
/////ЗАКАЗЫ/////
    // Метод возвращает страницу с выводом списка заказов и кладет объект заказа в модель
    @GetMapping("/order")
