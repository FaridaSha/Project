...
public class MainController {
    ...
    @PostMapping("/search")
    public String productSearch(@RequestParam("search") String search, @RequestParam("ot")
    String ot, @RequestParam("do") String Do, @RequestParam(value = "price", required = false,
            defaultValue = "") String price, @RequestParam(value = "category", required = false,
                ...
                if (price.equals("sorted_by_ascending_price")) {
                    ...
                    if (!category.isEmpty()) {
                        ...
                        if (category.equals("furniture")) {
                            ...
                            // Если категория равная бытовой технике
    ...
    @PostMapping("/search1")
    public String productSearch1(@RequestParam("search1") String search1, @RequestParam("ot1")
    String ot1, @RequestParam("do1") String Do1, @RequestParam(value = "price", required = false,
            defaultValue = "") String price, @RequestParam(value = "category", required = false,
            defaultValue = "") String category, Model model){
